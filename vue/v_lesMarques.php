	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<form action="index.php?uc=gererMarques" method="post">
				<td>Nouveau</td>
				<td>
					<input type="text" id="txtNomMarque" name="txtNomMarque" size="24" required minlength="4"  maxlength="24"  placeholder="nomMarque" title="De 4 à 24 caractères"  />
				</td>
				<td> 
			  ...
			  <tr>
				...
				<td><?php 
					...
					<?php
						...
						?><input type="text" id="txtNomMarque" name="txtNomMarque" size="24" required minlength="4"  maxlength="24"   value="<?php echo $marque->nom; ?>" />     
						</td>
						<td>		 
